...
#if defined (__ES2_DA14531__) && !defined (__EXCLUDE_ROM_APP_TASK__) // ES2 DA14531 and app task at ROM
/*
 ****************************************************************************************
 * @brief Handles GAPC_PEER_FEATURES_IND message.
 * @param[in] msgid     Id of the message received.
...
#if defined (__ES2_DA14531__) && !defined (__EXCLUDE_ROM_APP_TASK__) // ES2 DA14531 and app task at ROM
// Extra message handlers which are not built in ES2 DA14531 ROM
...
#if defined (__DA14531__) && !defined (__ES2_DA14531__) && !defined (__EXCLUDE_ROM_APP_TASK__)
#define APP_GAP_PROCESS_HANDLERS_SIZE       (14) // ROM-defined app_gap_process_handlers[] size
extern const struct ke_msg_handler app_gap_process_handlers[APP_GAP_PROCESS_HANDLERS_SIZE];
#endif
