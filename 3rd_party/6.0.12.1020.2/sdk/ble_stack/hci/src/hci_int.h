...
/**
 ****************************************************************************************
 * @brief Informs the HCI TL Layer that a  host command will not be replied, since a disconnection
 * complete event has already been sent to the host.
 *****************************************************************************************
 */
void hci_tl_host_cmd_discarded(void);
