...
#define LLD_RX_IRQ_THRES   rom_cfg_table[lld_rx_irq_thres_pos]//(BLE_RX_BUFFER_CNT/2)

/// Basic rate and Enhanced Data Rate
#define MOD_GFSK            0x01

#if defined (__DA14531__) && !defined (__ES2_DA14531__)
/// Power Level Read requests
#define TX_PWR_LVL_CURRENT  1
#define TX_PWR_LVL_MAX      2
#endif
