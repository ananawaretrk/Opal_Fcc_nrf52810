...
#if defined (__ES2_DA14531__)
    #define __SCT_AUTO_HEAP_ENV_SIZE    (((200 + 4) + (244 + 4) + (148 + 4) + (28 + 4)) * BLE_CONNECTION_MAX_USER) // only for ES2 DA14531
#elif defined (__DA14531__)
    #define __SCT_AUTO_HEAP_ENV_SIZE    (((244 + 4) + (248 + 4) + (148 + 4) + (28 + 4)) * BLE_CONNECTION_MAX_USER) // only for ES3 DA14531
#else
