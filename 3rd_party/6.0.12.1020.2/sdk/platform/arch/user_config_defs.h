 ...
 */
    ...
    timer_easy_config_pos,      // not used
#endif
    custs1_prf_conf_pos,
    prfconf_config_pos,
    appconf_config_pos,
    console_config_pos,
#if defined (__ES2_DA14531__)
    sleep_config_pos,           // not used
    appsuota_config_pos,        // not used
    appdiss_config_pos,         // not used
    appeasymsg_config_pos,      // not used
    system_config_pos           // not used
#endif
#endif
};
