...
#define MY_BLE_FEATURES_BYTE0 (BLE_ENC_FEATURE | BLE_REJ_IND_EXT_FEATURE | BLE_SLAVE_INIT_EXCHG_FEATURE | BLE_PING_FEATURE \
...
#if (__DA14531__) && !defined (__ES2_DA14531__)
