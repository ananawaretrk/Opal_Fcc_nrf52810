 ...
 ************************************************************
 */
#define USER_CFG_FEAT_AUTH_REQ  (GAP_AUTH_BOND | GAP_AUTH_SEC)
 ...
 **************************************************************************************
 */
#define USER_CFG_FEAT_INIT_KDIST (GAP_KDIST_ENCKEY)
 ...
 **************************************************************************************
 */
#define USER_CFG_FEAT_RESP_KDIST (GAP_KDIST_ENCKEY)

/*************************************************************************
 * Privacy feature:
 *
 * - Random Static Address          (#define USER_CFG_PRIV_GEN_STATIC_RND)
 * - Resolvable Private Address     (#define USER_CFG_PRIV_GEN_RSLV_RND)
 *
 ...
 */
/// Device name
#define USER_DEVICE_NAME        "DLG-AES"
