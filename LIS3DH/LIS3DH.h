...
public:
  ...
  void controlInt(bool onoff,int threshold, int duration);
  uint8_t serviceInt();
  uint8_t serviceReferenceInt();
  void controlmotionInt(bool onoff,int threshold);
  void controlFilteredRelativeInt(bool onoff,int threshold, int duration);
protected:
